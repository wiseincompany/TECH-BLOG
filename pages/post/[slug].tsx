...
const Post = ({ markdown, post }: InferGetStaticPropsType<typeof getStaticProps>) => {
  const result = markdown.replace(
    /img/g,
    'img loading="lazy" style="margin: auto; object-fit: cover; image-rendering: -webkit-optimize-contrast; transform: translateZ(0); backface-visibility: hidden; "'
  )
  return (
    <>
      <Head>
        ...
        <div className="min-h-screen my-10">
          <main className="max-w-5xl mx-auto relative">
            ...
            <div className="text-center mb-20">
              <Image loading="lazy" className="rounded-xl align-top" priority objectFit="contain" src={post.cover} alt="" width={700} height={500} quality={100} />
            </div>
